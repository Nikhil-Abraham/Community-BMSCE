    ...
    <div class="bg-custom_white h-screen  text-custom_grey-150 font-Nato font-semibold   ">
      <Header />
        ...
        <div id="register_area-jq" class="container  punchline flex flex-col items-center 
            ...
            <div class="py-6 mx-20 mt-6  text-xl ...">SIGN UP</div>
      ...
      <form action="/intro" method="post"  name="register-form"  >
        <div class="form-group px-6 py-6 ...">
          ...
          <input   type="email" class="form-control mt-1 rounded-lg ..." placeholder="    Enter email" id="email">
          </input>
          </div>
        <div class="form-group px-6 py-6 ...">
          <label class="form-label" for="pwd">Password:</label><br/>
          <input  type="password" class="form-control mt-1 rounded-lg ..." placeholder="    Enter password" id="pwd">
          </input>
          </div>
        <div class="form-group px-6 py-6 ...">
